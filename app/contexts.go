...
func (payload *createTasksPayload) Validate() (err error) {
...
// Validate runs the validation rules defined in the design.
func (payload *updateTasksPayload) Validate() (err error) {
	if payload.Title == nil {
		err = goa.MergeErrors(err, goa.MissingAttributeError(`raw`, "title"))
	}
	if payload.Done == nil {
		err = goa.MergeErrors(err, goa.MissingAttributeError(`raw`, "done"))
	}
	return
}
